...
const init = ()=>{
    ...
    } else if (currentURL.includes('stories')) storiesLinks.forEach((link)=>{
        link.classList.add('selected');
    });
    else if (currentURL.includes('features')) featuresLinks.forEach((link)=>{
        link.classList.add('selected');
    });
    else homeLink.classList.add('selected');
};
init();

},{}]},["1B2dF","dV6cC"], "dV6cC", "parcelRequire6d81")

//# sourceMappingURL=stories.e82f28a0.js.map
